...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchRequest *fetchRequest = [Location requestAllSortedBy:@"timestamp" ascending:NO];
    ...
    NSFetchedResultsController *aFetchedResultsController = [[[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:[NSManagedObjectContext context] sectionNameKeyPath:nil cacheName:@"Master"] autorelease];
